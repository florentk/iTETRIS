...
//   std::cout << "PHY: Receive rxPower=" << rxPower << ", Nwb=" << Nwb << ", SNR=" << SNR << ", Modulation="
//                                        << modulationType << ", BlocErrorRate=" << blockErrorRate << ", drop=" << (int) drop << std::endl;
...
//          std::cout << "[SimpleOfdmWimaxPhy::EndReceiveFecBlock] Received OK" <<std::endl;
        }
      else
        {
//          std::cout << "[SimpleOfdmWimaxPhy::EndReceiveFecBlock] Not received" <<std::endl;
...
{
//   std::cout << "[SimpleOfdmWimaxPhy::EndReceive]" <<std::endl;
