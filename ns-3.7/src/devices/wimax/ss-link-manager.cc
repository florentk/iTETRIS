...
{
//   std::cout << "SSLinkManager::EndScanning" << std::endl;
//   abort ();
  if (status)
    {
      StartSynchronizing ();
...
{
//   std::cout << "SSLinkManager::StartSynchronizing" << std::endl;
//   abort ();
...
{
//   std::cout << "SSLinkManager::StartContentionResolution" << std::endl;
//   abort ();
  NS_ASSERT_MSG (
    m_ss->GetState ()
...
{
//   std::cout << "SSLinkManager::ScheduleScanningRestart" << std::endl;
