...
/// @date    Sept 2002
/// @version $Id: TraCIServerAPI_Edge.cpp 23694 2017-03-28 20:07:13Z namdre $
///
    ...
    if (variable == ID_LIST) {
        ...
        switch (variable) {
            ...
            case LAST_STEP_PERSON_ID_LIST: {
                ...
                std::vector<MSTransportable*> persons = e->getSortedPersons(MSNet::getInstance()->getCurrentTimeStep(), true);
